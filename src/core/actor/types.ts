...
export type ActorKind = "player" | "enemy"; // extend as new actor kinds appear
...
export function isCharacter(a: Actor): a is Character {
  // All current actor kinds are characters. Broaden this guard when non-
  // character actors (crops, loot drops) are added.
